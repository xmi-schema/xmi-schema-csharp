...
| `XmiStructuralPointConnection` | Analytical node that ties members and storeys together. | Create through `XmiModel.CreateXmiStructuralPointConnection` to automatically reuse identical coordinates. |
